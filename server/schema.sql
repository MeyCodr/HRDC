...
('MANUFACTURING & SCM BB/RASA'),
('MANUFACTURING & SCM PEGOH'),
('MANUFACTURING & SCM PEKAN'),
('MANUFACTURING & SCM SA1'),
('MANUFACTURING & SCM SA2'),
('MANUFACTURING & SCM TM1 (FIF)'),
('MANUFACTURING & SCM TM2 (OSI)'),
('INVENTORY MANAGEMENT PLANNING (IMP)'),
('ENGINEERING MANAGEMENT 1'),
('ENGINEERING MANAGEMENT 2'),
('ENERGY & FACILITY MANAGEMENT'),
('EQUIPMENT MAINTENANCE 1 (SA1, BB/RASA & PGH)'),
('EQUIPMENT MAINTENANCE 2 (SA2, DHMSB, TM1 & TM2)'),
('PROCESS ENGINEERING'),
...
('COO OFFICE'),
('QUALITY SYSTEM & BCM'),
('QUALITY ASSURANCE & CONTROL 2 (BB/RASA, TM 1 & TM 2)'),
('QUALITY ASSURANCE & CONTROL 3 (PEGOH & PEKAN)'),
('QUALITY ASSURANCE & CONTROL 1 (SA1 & SA2)'),
('QUALITY DEVELOPMENT');
